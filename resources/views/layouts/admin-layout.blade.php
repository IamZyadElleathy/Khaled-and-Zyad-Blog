...
<head>
  ...
  <title>Admin Dashboard - Khaled&Zyad</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/admin/home" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Khaled&Zyad</span>
      </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Khaled&Zyad</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
